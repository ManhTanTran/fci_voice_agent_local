...
| 04 | [`04_asr_telephony/`](04_asr_telephony/00_README.md) | ASR môi trường 8kHz/nhiễu (robust + streaming + confidence) — nối lab `nvidia_asr_nemo` | 🟢 v1 (chưa verify 3-vote) |
| 05 | [`05_turn_interruption/`](05_turn_interruption/00_README.md) | **Quản lý lượt lời (turn-taking)**: turn-detection/endpointing (EOU) · barge-in & semantic interruption · backchannel — **bài đau #1** ở nhánh interruption (76% / 280ms) | 🟢 v1 (chưa verify 3-vote) |
...
| 10 | [`10_implementation/`](10_implementation/00_README.md) | **TRIỂN KHAI (code thật + thực nghiệm DGX):** [tổng kết kiến trúc as-built](10_implementation/01_architecture.md) + [report thông luồng exp01→04](10_implementation/02_e2e_report.md) (sơ đồ pipeline + latency từng step) | 🟢 full loop English chạy thật |

> Layer 01–09 = khảo sát theo đường đi tín hiệu; **layer 10 = track triển khai** (trục khác: code + exp chạy được trên DGX).
>
